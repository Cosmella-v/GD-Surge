...
void MyAchievementManager::addManualAchievements() {
    ...
    AchievementManager::addAchievement("geometry.ach.coins03", "I.. Need... MORE!", "Collected 15 Secret Coins", "Collect 15 Secret Coins", "color2_01", 1);
    ...
    AchievementManager::addAchievement("geometry.ach.coins06", "Must have the precious", "Collected 30 Secret Coins", "Collect 30 Secret Coins", "color_01", 1);
    ...
    AchievementManager::addAchievement("geometry.ach.jump01", "Bounce", "Jumped 1000 times", "Jump 1000 times", "color2_02", 0);
    AchievementManager::addAchievement("geometry.ach.jump02", "I like jumping", "Jumped 10000 times", "Jump 10000 times", "color2_03", 0);
    AchievementManager::addAchievement("geometry.ach.jump03", "You jump like a pro!", "Jumped 20000 times", "Jump 20000 times", "color2_04", 0);
    ...
    AchievementManager::addAchievement("geometry.ach.jump06", "Jumper", "Jumped 200000 times", "Jump 200000 times", "color_02", 0);
    ...
    AchievementManager::addAchievement("geometry.ach.attempt01", "Trial and error", "Did 100 attempts", "Do 100 attempts", "color2_05", 0);
    AchievementManager::addAchievement("geometry.ach.attempt02", "Crash Tester", "Did 500 attempts", "Do 500 attempts", "color_03", 0);
    AchievementManager::addAchievement("geometry.ach.attempt03", "You Shall Not Pass!", "Did 2000 attempts", "Do 2000 attempts", "color_04", 0);
    AchievementManager::addAchievement("geometry.ach.attempt04", "Ouch...", "Did 10000 attempts", "Do 10000 attempts", "color2_05", 0);
    ...
    AchievementManager::addAchievement("geometry.ach.attempt07", "Never Surrender", "Did 40000 attempts", "Do 40000 attempts", "color_05", 0);
    ...
    AchievementManager::addAchievement("geometry.ach.facebook", "Number one fan!", "Liked Geometry Dash on Facebook", "Like Geometry Dash on Facebook", "color2_06", 0);
    AchievementManager::addAchievement("geometry.ach.youtube", "GeometryTube", "Subscribed to RobTop Games on YouTube", "Subscribe to RobTop Games on YouTube", "color2_07", 0);
    AchievementManager::addAchievement("geometry.ach.twitter", "Geometry Bird!", "Followed RobTop Games on Twitter", "Follow RobTop Games on Twitter", "color_06", 0);
    ...
    AchievementManager::addAchievement("geometry.ach.secret01", "Rampage!", "Destroyed a player", "A secret is required", "color2_08", 0);
    AchievementManager::addAchievement("geometry.ach.secret02", "Dominating!", "Destroyed 50 players", "A secret is required", "icon_41", 0);
    AchievementManager::addAchievement("geometry.ach.secret02b", "Ultrakill!", "Destroyed 100 players", "A secret is required", "color_07", 0);
    ...
    AchievementManager::addAchievement("geometry.ach.secret04", "Master Detective", "Found the hidden coin", "A hidden treasure is required", "color_08", 0);
}