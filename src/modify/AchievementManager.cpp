...
void MyAchievementManager::addManualAchievements() {
    ...
    AchievementManager::addAchievement("geometry.ach.surge.vault03", "The Gauntlet", "Complete The Guard's special quest", "A secret is required", "ship_174", 0);
    ...
    AchievementManager::addAchievement("geometry.ach.demon01", "Reflex Champion", "Completed a Demon difficulty level in Normal mode", "Complete a Demon difficulty level in Normal mode", "icon_487", 1);

    AchievementManager::addAchievement("geometry.ach.coins01", "Coins?!", "Collected 5 Secret Coins", "Collect 5 Secret Coins", "icon_488", 1);
    AchievementManager::addAchievement("geometry.ach.coins02", "Maybe behind that block?", "Collected 10 Secret Coins", "Collect 10 Secret Coins", "ball_122", 1);
    ...
    AchievementManager::addAchievement("geometry.ach.jump09", "One hop this time!", "Jumped 500000 times", "Jump 500000 times", "icon_490", 0);
    AchievementManager::addAchievement("geometry.ach.jump10", "Leaps and bounds!", "Jumped 750000 times", "Jump 750000 times", "dart_103", 0);
    AchievementManager::addAchievement("geometry.ach.jump11", "Jump King", "Jumped 1000000 times", "Jump 1000000 times", "swing_46", 0);
    ...
    AchievementManager::addAchievement("geometry.ach.secret03b", "Wickedsick!", "Destroyed 500 players", "A secret is required", "ball_126", 0);
