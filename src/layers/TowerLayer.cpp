...
void TowerLayer::keyBackClicked() {
    CCDirector::sharedDirector()->popSceneWithTransition(0.5f, PopTransition::kPopTransitionFade);
}

void TowerLayer::backWrapper(CCObject* sender) {
    TowerLayer::keyBackClicked();
}

CCScene* TowerLayer::scene() {
    auto scene = CCScene::create();
    scene->addChild(TowerLayer::create());
    return scene;
}

TowerLayer* TowerLayer::create() {
    TowerLayer* ret = new TowerLayer();
...
bool TowerLayer::init(bool returning, bool nextFloorLocked) {
    ...
    if (auto menu = this->getChildByID("back-menu")) {
        ...
        btn->m_pfnSelector = menu_selector(TowerLayer::backWrapper);
    }
    ...
    if (auto menu = this->getChildByID("main-node")->getChildByID("main-menu")) {
        ...
        level5001->m_pfnSelector = menu_selector(TowerLayer::onDoor);
        ...
        level5002->m_pfnSelector = menu_selector(TowerLayer::onDoor);
        ...
        level5003->m_pfnSelector = menu_selector(TowerLayer::onDoor);
        ...
        level5004->m_pfnSelector = menu_selector(TowerLayer::onDoor);
    }
...
void TowerLayer::onDoor(CCObject* sender) {
...
// void TowerLayer::playLevel5005(CCObject*) {
//     playTowerLevel(5005);
// }

// void TowerLayer::playLevel5006(CCObject*) {
//     playTowerLevel(5006);
// }

// void TowerLayer::playLevel5007(CCObject*) {
//     playTowerLevel(5007);
// }

// void TowerLayer::playLevel5008(CCObject*) {
//     playTowerLevel(5008);
// }