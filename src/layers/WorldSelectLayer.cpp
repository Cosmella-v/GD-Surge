     ...
     //levels for verify and make the animation
      ...
      if (wlevel1->m_normalPercent == 100 && wlevel2->m_normalPercent == 0 && level1complete == 0)
      {
          ...
          level2Btn->runAction(CCSequence::create(
              ...
              CCCallFunc::create(this, callfunc_selector(ownWorldSelectLayer::runParticle)), // Utilizamos CCCallFunc para llamar a la funci�n runParticle
              CCFadeIn::create(0.1),
...
addChild(m_scrollLayer);
    ...
    auto callFunc = CCCallFunc::create(this, callfunc_selector(ownWorldSelectLayer::runScroll)); // Crear una acci�n que llame a la funci�n deseada
